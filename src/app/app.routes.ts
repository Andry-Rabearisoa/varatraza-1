...
import { OrganigrammeCompletComponent } from './pages/organigramme-complet/organigramme-complet.component';
...
export const routes: Routes = [
  ...
  { path: 'organigramme-complet', component: OrganigrammeCompletComponent },
